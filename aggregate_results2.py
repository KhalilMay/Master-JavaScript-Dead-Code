...
def aggregate_subject(subject, n_runs):
    ...
    fp_serie = pd.Series([subject.split('/')[-4]] + ordered_fp_values + [np.mean(ordered_fp_values)])

    ordered_fcp_values = [fcp_values[key] for key in sorted(fcp_values.keys())]
    fcp_serie = pd.Series([subject.split('/')[-4]] + ordered_fcp_values + [np.mean(ordered_fcp_values)])
    ...
    start_serie = pd.Series([subject.split('/')[-4]] + ordered_start_values + [np.mean(ordered_start_values)])
...
if __name__ == '__main__':
    ...
    level0_fp.to_csv('Aggregate_Metrics2/level0_Results_Fp.csv', header=True, index=None)
    level0_fcp.to_csv('Aggregate_Metrics2/level0_Results_Fcp.csv', header=True, index=None)
    level0_load.to_csv('Aggregate_Metrics2/level0_Results_Load.csv', header=True, index=None)
    level0_start.to_csv('Aggregate_Metrics2/level0_Results_Start.csv', header=True, index=None)
    ...
    level1_fp.to_csv('Aggregate_Metrics2/level1_Results_Fp.csv', header=True, index=None)
    level1_fcp.to_csv('Aggregate_Metrics2/level1_Results_Fcp.csv', header=True, index=None)
    level1_load.to_csv('Aggregate_Metrics2/level1_Results_Load.csv', header=True, index=None)
    level1_start.to_csv('Aggregate_Metrics2/level1_Results_Start.csv', header=True, index=None)
    ...
    level2_fp.to_csv('Aggregate_Metrics2/level2_Results_Fp.csv', header=True, index=None)
    level2_fcp.to_csv('Aggregate_Metrics2/level2_Results_Fcp.csv', header=True, index=None)
    level2_load.to_csv('Aggregate_Metrics2/level2_Results_Load.csv', header=True, index=None)
    level2_start.to_csv('Aggregate_Metrics2/level2_Results_Start.csv', header=True, index=None)
    ...
    level3_fp.to_csv('Aggregate_Metrics2/level3_Results_Fp.csv', header=True, index=None)
    level3_fcp.to_csv('Aggregate_Metrics2/level3_Results_Fcp.csv', header=True, index=None)
    level3_load.to_csv('Aggregate_Metrics2/level3_Results_Load.csv', header=True, index=None)
    level3_start.to_csv('Aggregate_Metrics2/level3_Results_Start.csv', header=True, index=None)
